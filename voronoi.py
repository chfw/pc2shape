...
class Context(object):
    ...
    def outEdge(self,edge):
        ...
        self.edges.append((edge.edgenum,sitenumL,sitenumR, edge.reg[0], edge.reg[1]))
        if(not self.triangulate):
            if self.plot:
                ...
                print " %d " % sitenumL,
                print "%d" % sitenumR,
                print " %s, %s" % (edge.reg[0].tag, edge.reg[1].tag)
...
#------------------------------------------------------------------
class Site(object):
    def __init__(self,x=0.0,y=0.0,sitenum=0,tag=""):
        self.x = x
        self.y = y
    ...
    def dump(self):
        print "Site #%d (%g, %g, %s)" % (self.sitenum,self.x,self.y, self.tag)
...
class SiteList(object):
    def __init__(self,pointList):
        ...
        for i,pt in enumerate(pointList):
            self.__sites.append(Site(pt.x,pt.y,i,pt.tag))
